"""Regression test for canonicalize_sources_field.
...
from _stage_3_write import canonicalize_sources_field
...
class TestCanonicalizeSources(unittest.TestCase):
    def test_comma_in_filename_stays_single_entry(self):
        ...
        result = canonicalize_sources_field(content, canonical)
