...
(matching `_core.py parse_file_blocks()`):
...
Note: index.md / log.md / overview.md are programmatically appended by Stage 3.5
(`stage_3_5_aggregate_repair`), NOT generated by the LLM. The LLM should only
