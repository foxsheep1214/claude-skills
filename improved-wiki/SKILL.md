...
- **Parallel I/O**: caption ∥ digest (Stage 1.3∥2.1), per-image caption dispatch (×4 workers, `CAPTION_MAX_WORKERS`; 4 stays under GLM-5v-turbo free-tier 429 limit). Pure I/O-bound parallelism only — no quality impact.
